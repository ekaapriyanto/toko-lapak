                ...
                <form className="flex flex-col items-start justify-start pt-10 pr-10 pb-10 pl-10 bg-white shadow-2xl rounded-xl relative z-10">
                  ...
                  <div className="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8">
                    ...
                    <div className="relative text-center">
                      <button
                        type="submit"
                        className="w-full mt-5 pt-3 pr-4 pb-3 pl-4 text-white bg-gradient-to-br from-red-500 to-red-800 hover:bg-gradient-to-bl font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
                      >
                        Submit
                      </button>
