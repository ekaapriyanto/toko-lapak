...
import ImageContact from "@/assets/doodle.png";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 grid md:grid-cols-2 lg:grid-cols-2 gap-y-8 md:gap-x-8 md:gap-y-8 lg:gap-x-8 lg:gap-y-16">
          <div>
            ...
            <div className="flex items-center mt-8 space-x-2 text-dark-600 dark:text-gray-400">
              ...
              <span>jl. Buntu, No. 69, Puter Balik Mase</span>
            </div>
            <div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-gray-400">
              ...
              <a href="mailto:hello@company.com">tokolapak@gmail.com</a>
            </div>
            <div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-gray-400">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <a href="tel:11111111111">+62 877 1234 5678</a>
            </div>
          </div>
          <div>
            <form>
